    ...
    <footer className="border-t border-slate-200 dark:border-slate-800 mt-auto">
      <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div className="flex gap-4">
          <Link href="/search" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">Search</Link>
          <Link href="/login" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">Log in</Link>
          <Link href="/register" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">Sign up</Link>
        </div>
      </div>
    </footer>
  );
